...
const Grilo = new Lang.Class({
    ...
    getAlbumSongs: function (album_id, callback) {
        ...
        grilo.tracker.query(
            query,
                [Grl.METADATA_KEY_ID, Grl.METADATA_KEY_TITLE, Grl.METADATA_KEY_ARTIST, Grl.METADATA_KEY_DURATION, Grl.METADATA_KEY_CREATION_DATE, Grl.METADATA_KEY_TRACK_NUMBER],
                options,
                Lang.bind(this, callback, null));
    },
